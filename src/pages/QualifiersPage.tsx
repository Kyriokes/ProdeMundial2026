...
export const QualifiersPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-2 text-gray-800">Fase de Clasificación</h1>
      <p className="text-center text-gray-600 mb-8">Selecciona los ganadores de los repechajes para completar los grupos.</p>
