// Generated from Annexe C in wc-2026-regulations.docx
// Maps the 495 official combinations of best third-placed teams to the round-of-32 bracket assignments.
...
export function getPatternForCombination(thirds: string[]): ThirdPlacePattern {
  ...
  const pattern = thirdCombinationMap[key];

  if (!pattern) {
    throw new Error(`Unsupported third-place combination: ${key}`);
  }
